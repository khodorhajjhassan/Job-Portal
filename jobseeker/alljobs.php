...
<div class="container">
        ...
        $q=mysqli_query($db1,"select * from jobs ");
        if(mysqli_num_rows($q)>0) {
            echo "<h2><center>All kind of jobs:</center></h2>";?>
            <br>
   ...
   $i=1;
            ...
            echo " <tr> ";
                    echo "<td>".$i."</td>";
               echo "<td><h3> <a style='color: green;'  href='view_jobs.php?jid=" . $result2['jobid'] . "'>".$result2['title']."</a></h3></td>"; 
